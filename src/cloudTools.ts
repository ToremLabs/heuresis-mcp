...
export const CLOUD_TOOLS: CloudToolDef[] = [
  ...
  },
  {
    name: 'get_subtree',
    description:
      'A node and its descendants up to a given depth. Use when the user asks "tell me about everything under X".',
  ...
  },
  {
    name: 'remove_concept',
    description:
      'Hard-delete a concept and its descendants (walks the parent_id subtree). Edges and project/idea memberships cascade via FK. Refuses to delete a project root node.',
  ...
  },
  {
    name: 'delete_project',
    description:
      "Delete a project. Project_nodes / problem_frames / closed_worlds / lab_matrix_cells cascade via FK. Concepts that belonged to ONLY this project are orphaned (project_id → NULL) — they are NOT auto-deleted.",
